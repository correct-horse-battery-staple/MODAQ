...
class ErrorBoundary extends React.Component<IErrorBoundaryProps, IErrorBoundaryState> {
    ...
    public render() {
        if (this.state.error) {
            ...
            // Crash recovery must always offer the REAL game: during a tutorial the practice game is
            // disposable, and the moderator's actual game is the only data worth downloading.
